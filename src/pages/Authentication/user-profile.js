...
import {
  ...
  listlabs,
  updatePatient,
} from "../../functions/Patient/Patient";
...
const UserProfile = () => {
  ...
  const [hasExistingPharmacy, setHasExistingPharmacy] = useState(false);
  ...
  const validateForm = () => {
    ...
    if (!PatientReferenceNo)
      errors.PatientReferenceNo = "Reference No is required";
    if (!PatientRegistrationDate)
      errors.PatientRegistrationDate = "Registration Date is required";
    ...
    if (!FamilyDoctor1 && !newDoctor)
      errors.FamilyDoctor1 = "Family Doctor is required";
    if (newDoctor) {
      console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
      if (!FamilyDoctorName)
        errors.FamilyDoctorName = "Family Doctor Name is required";
      if (!FamilyDoctorMobile)
        errors.FamilyDoctorMobile = "Family Doctor Mobile is required";
      if (!FamilyDoctorAddress)
        errors.FamilyDoctorAddress = "Family Doctor Address is required";
      if (!FamilyDoctorPincode)
        errors.FamilyDoctorPincode = "Family Doctor Pincode is required";
    }
    ...
    if (newPharmacy) {
      ...
      if (!PharmacyMobile)
        errors.PharmacyMobile = "Pharmacy Mobile is required";
      if (!PharmacyAddress)
        errors.PharmacyAddress = "Pharmacy Address is required";
      if (!PharmacyPincode)
        errors.PharmacyPincode = "Pharmacy Pincode is required";
    }
    if (!Laboratory1 && !newLaboratory)
      errors.Laboratory1 = "Laboratory is required";
    if (newLaboratory) {
      if (!LaboratoryName)
        errors.LaboratoryName = "Laboratory Name is required";
      if (!LaboratoryMobile)
        errors.LaboratoryMobile = "Laboratory Mobile is required";
      if (!LaboratoryAddress)
        errors.LaboratoryAddress = "Laboratory Address is required";
      if (!LaboratoryPincode)
        errors.LaboratoryPincode = "Laboratory Pincode is required";
    }
    ...
    if (newHospital) {
      ...
      if (!HospitalMobile)
        errors.HospitalMobile = "Hospital Mobile is required";
      if (!HospitalAddress)
        errors.HospitalAddress = "Hospital Address is required";
      if (!HospitalPincode)
        errors.HospitalPincode = "Hospital Pincode is required";
    }
  ...
  const handleEditSubmit = async () => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      try {
        updatePatient(userId, formData).then((res) => {
          console.log("ffr", res);
          toggleEditModal();
        });
      } catch (error) {
  ...
  const validate = () => {
    ...
    if (Password === "") {
      ...
      seterrLoginPassword(true);
    } else {
      seterrLoginPassword(false);
    }
    ...
    if (cantFindLab === true) {
      ...
      if (!LaboratoryAddress) {
        errors.LaboratoryAddress =
          "Laboratory Address is required is required!";
        setErrLabAdd(true);
      } else {
        setErrLabAdd(false);
      }
  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/api/auth/getPatient/${userId}`
      );
      ...
      setFamilyDoctor1(userData.FamilyDoctor1 || null);
      ...
      setPharmacy1(userData.Pharmacy1 || null);
      ...
      setHasExistingPharmacy(!!userData.Pharmacy1);

      setLaboratory1(userData.Laboratory1 || null);
      ...
      setHospital1(userData.Hospital1 || null);
      ...
      setDoctorphoto(`${process.env.REACT_APP_API_URL}/${userData.photo}`);
  ...
  document.title = `Profile | ${PatientName}`;
            ...
            <Col lg="12">
              ...
              <Card>
                ...
                <CardBody>
                  <Row>
                    <div
                      className="d-flex position-relative z-index-1"
                    ...
                    >
                      ...
                      <Col lg="8">
                        <Row>
                          <Col lg="6">
                            <div className="flex-grow-1 align-self-center mx-3 mt-5">
                              <div className="text-muted">
                                ...
                                <p className="mb-1 mt-2">
                                  Reference No: &nbsp;{PatientReferenceNo}
                                </p>
                                <p className="mb-1">
                                  Registration Date:{" "}
                                  {new Date(
                                ...
                                <p className="mb-1">PAN Card: {Pancard}</p>
                                <p className="mb-3">
                                  Aadhar Card: {Aadharcard}
                                </p>
                                <p className="mb-1">
                                  Family Doctor:{" "}
                                  {FamilyDoctor1 ? getDoctorNameById(FamilyDoctor1, doctordata) :"-"}
                                </p>
                                <p className="mb-1">
                                  Pharmacy:{" "}
                                  {Pharmacy1 ? getPharmacyNameById(Pharmacy1, pharmacydata) :"-"}
                                </p>
                                <p className="mb-1">
                                  Laboratory:{" "}
                                  {console.log(Laboratory1)}
                                  {Laboratory1 ? getLabNameById(Laboratory1 || "", laboraterydata) : "-"}
                                </p>
                                <p className="mb-3">
                                  Hospital:{" "}
                                  {Hospital1 ? getHospitalNameById(Hospital1, Hospitaldata) :"-"}
                                </p>
                                {/* <p className="mb-1">Family Doctor Mobile: {FamilyDoctorMobile}</p>
                        <p className="mb-1">Family Doctor Address: {FamilyDoctorAddress}</p>
                        <p className="mb-1">Family Doctor Pincode: {FamilyDoctorPincode}</p> */}
                                {/* <p className="mb-1">Pharmacy Mobile: {PharmacyMobile}</p>
                        <p className="mb-1">Pharmacy Address: {PharmacyAddress}</p>
                        <p className="mb-1">Pharmacy Pincode: {PharmacyPincode}</p> */}
                                {/* <p className="mb-1">Laboratory Mobile: {LaboratoryMobile}</p>
                        <p className="mb-1">Laboratory Address: {LaboratoryAddress}</p>
                        <p className="mb-1">Laboratory Pincode: {LaboratoryPincode}</p> */}
                                {/* <p className="mb-1">Hospital Mobile: {HospitalMobile}</p>
                        <p className="mb-1">Hospital Address: {HospitalAddress}</p>
                        <p className="mb-1">Hospital Pincode: {HospitalPincode}</p> */}
                                <p className="mb-1">
                          ...
                          <Col lg="6">
                            <div className="flex-grow-1 align-self-center mx-3 mt-5">
                              ...
                              >
                                <p className="mb-1">Area: &nbsp;{Area}</p>
                                <p className="mb-1">
                                  City: &nbsp;{getCityById(City, citydata)}
                                </p>{" "}
                                {/*{getCityById(city, citydata)} */}
                      ...
                      <Col lg="2">
                        <div className="d-flex align-items-start mt-5 ms-5 float-end">
      ...
      >
        ...
        <ModalBody>
          <Row>
            <Col md={4}>
              <FormGroup>
                ...
                />
                <FormFeedback>{formErrors.PatientName}</FormFeedback>
              </FormGroup>
            </Col>
            <Col md={4}>
              <FormGroup>
                <Label for="PatientReferenceNo">Reference No</Label>
                <Input
                  type="text"
                  id="PatientReferenceNo"
                  value={PatientReferenceNo}
                  onChange={(e) => setPatientReferenceNo(e.target.value)}
                  invalid={!!formErrors.PatientReferenceNo}
                  readOnly
                />
                <FormFeedback>{formErrors.PatientReferenceNo}</FormFeedback>
              </FormGroup>
            </Col>
            <Col md={4}>
              <FormGroup>
                <Label for="PatientRegistrationDate">Registration Date</Label>
                <Input
                  type="date"
                  id="PatientRegistrationDate"
                  value={PatientRegistrationDate}
                  onChange={(e) => setPatientRegistrationDate(e.target.value)}
                  className={validClassMN}
                />
                <FormFeedback>
                  {formErrors.PatientRegistrationDate}
                </FormFeedback>
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md={3}>
              <FormGroup>
                ...
                />
                <FormFeedback>{formErrors.MobileNumber}</FormFeedback>
              </FormGroup>
            </Col>
            <Col md={3}>
              <FormGroup>
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <Input
                  ...
                  className={validClassEmailP}
                />
                <FormFeedback>{formErrors.EmailP}</FormFeedback>
              </FormGroup>
            </Col>
          </Row>
          ...
          <Row>
            <Col md={4}>
              <FormGroup>
                ...
                />
                <FormFeedback>{formErrors.Area}</FormFeedback>
              </FormGroup>
            </Col>
            <Col md={4}>
              <FormGroup>
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <Input
                  ...
                  className={validClassPan}
                />
                <FormFeedback>{formErrors.Pancard}</FormFeedback>
              </FormGroup>
            </Col>
            <Col md={6}>
              <FormGroup>
                ...
                <Input
                  ...
                  className={validClassAadhar}
                />
                <FormFeedback>{formErrors.Aadharcard}</FormFeedback>
              </FormGroup>
            </Col>
          </Row>
          {/*  Doctor */}
          <Row>
            ...
            {/*onClick={() => setNewDoctor(!newDoctor)} */}
          </Row>
          {newDoctor && (
            <>
              <Row>
                ...
                <Col md={3}>
                  <FormGroup>
                    ...
                    />
                    <FormFeedback>
                      {formErrors.FamilyDoctorAddress}
                    </FormFeedback>
                  </FormGroup>
                </Col>
                <Col md={3}>
                  <FormGroup>
                    <Label for="FamilyDoctorPincode">
                      Family Doctor Pincode
                    </Label>
                    <Input
                      type="text"
                    ...
                    />
                    <FormFeedback>
                      {formErrors.FamilyDoctorPincode}
                    </FormFeedback>
                  </FormGroup>
                </Col>
              </Row>
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                ...
                {hasExistingPharmacy && (
                  <Alert color="info" style={{ marginTop: "10px", fontSize: "14px" }}>
                    <i className="bx bx-info-circle me-2"></i>
                    You already have a preferred pharmacy selected. Contact support if you need to change it.
                  </Alert>
                )}
              </FormGroup>
            </Col>
            <Col md={6}>
              <Button
                style={{
                  ...
                  margin: "20px auto",
                  padding: "10px 20px",
                  backgroundColor: hasExistingPharmacy ? "#ccc" : "#E75480",
                  color: "white",
                  border: "none",
                  borderRadius: "5px",
                  cursor: hasExistingPharmacy ? "not-allowed" : "pointer",
                }}
                disabled={hasExistingPharmacy}
                onClick={() => {
          ...
          {newPharmacy && !hasExistingPharmacy && (
            <>
              <Row>
                <Col md={3}>
                  <FormGroup>
                ...
                <Col lg={3}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setLaboratoryMobile(e.target.value);
                      }}
                    />
                    <FormFeedback>{formErrors.LaboratoryName}</FormFeedback>
                  </FormGroup>
                ...
                <Col lg={3}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setLaboratoryAddress(e.target.value);
                      }}
                    />
                ...
                <Col lg={3}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setLaboratoryPincode(e.target.value);
                      }}
                    />
                ...
                <Col lg={3}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setHospitalPincode(e.target.value);
                      }}
                    />
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                <Label for="doctorphoto">Profile Photo</Label>
                <Input
                  type="file"
                  id="doctorphoto"
