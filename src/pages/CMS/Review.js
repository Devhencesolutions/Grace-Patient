...
const Review = () => {
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL}/api/auth/list-by-params/userreview`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
  ...
  document.title = "Products Category | Grace Labs";
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">User Review</h2>
                    </Col>
