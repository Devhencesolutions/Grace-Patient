...
const LabReports = () => {
  ...
  const fetchUsers = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL}/api/auth/labReports/listByParams/patients`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
  ...
  const col = [
    ...
    {
      name: "Report Type",
      cell: (row) => row.ReportType?.TestName,
      sortable: true,
      sortField: "area",
      minWidth: "150px",
      maxWidth: "200px",
    ...
    {
      name: "Referred By",
      cell: (row) => row.ReferredBy?.DoctorName,
      sortable: true,
  ...
  document.title = "Lab Reports | Grace Labs";

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb maintitle="Setup" title="Lab Reports" pageTitle="Setup" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Lab Reports</h2>
                    </Col>
